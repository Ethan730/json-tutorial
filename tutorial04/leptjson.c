...
static void lept_encode_utf8(lept_context* c, unsigned u) {
	...
	/* \TODO */
	// the below one is more simple since only one judgement is required
	...
	//else if (u >= 0x10000 && u <= 0x10FFFF) {
		...
		PUTC(c, 0xF0 | ((u >> 18) & 0x07)); /* 0xE0 = 11100000 */
		PUTC(c, 0x80 | ((u >> 12) & 0x3F)); /* 0x80 = 10000000 */
		PUTC(c, 0x80 | ((u >> 6) & 0x3F)); /* 0x3F = 00111111 */
		PUTC(c, 0x80 | (u & 0x3F)); /* 0x3F = 00111111 */
	}
}
